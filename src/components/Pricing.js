            ...
            <div className="pricing-content">
                ...
                <div className="pricing-rect">
                    ...
                    <div className="img-container">
                        <div className="img-div">
                            <img src="https://myxpresspay.com:8095/masterCard.svg" alt="MasterCard" />
                            <p>Master Card</p>
                        </div>
                        ...
                        <div className="img-div">
                            <img src="https://myxpresspay.com:8095/verve.svg" alt="VerveCard" />
                            <p>Verve Card</p>
                        </div>

                        <div className="img-div">
                            <img src="https://myxpresspay.com:8095/afrigo.png" alt="AfrigoCard" />
                            <p>Afrigo Card</p>
                        </div>
                    </div>
                ...
                <div className="pricing-rect">
                    ...
                    <div className="img-container">
                        ...
                        <div className="img-div">
                            <img src="https://myxpresspay.com:8095/unionpay.svg " alt="UnionPay" />
                            <p>Union Pay</p>
                        </div>

                        <div className="img-div">
                            <img src="https://myxpresspay.com:8095/american-express.png" alt="AmericaExpress" />
